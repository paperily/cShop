...
<div class="products">
	<div class="container">
		...
		<div class="col-md-9">
			...
			<c:forEach items="${prolist}" var="p" begin="0" end="2" step="1">
				<div class="col-md-4 col-md3"><a href="product?id=${p.id }">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="single.html">
							<img class="img-responsive" src="images/pi.png" alt="" />
						</a>
						<h3><a href="single.html">${p.name }</a></h3>
						<div class="price">
								<h5 class="item_price">${p.price }</h5>
								<a href="/cShop/cartAction/add?id=${p.id }" class="item_add">Add To Cart</a>
								<div class="clearfix"> </div>
						</div>
					</div>
				</a></div>	
