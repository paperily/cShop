		...
		<div class="col-md-9 content_right">
		   ...
		   <div class="register">
			  <div class="col-md-6 login-right">
			  	<h3>管理员管理页</h3>
				<p>后台管理员管理模块</p>
				<form action="/cShop/userlist" method="post">
				  <input type="submit" value="用户管理">			  
			    </form>
			    <form action="/cShop/backProductShow" method="post">
				  <input type="submit" value="商品管理">
			    </form>
			    <form action="/cShop/orderlist" method="post">
				  <input type="submit" value="订单管理">
			    </form>
			   </div>
